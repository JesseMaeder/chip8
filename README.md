...
|-------------|--------|-----------|-------------|
| - [x] | 0NNN | | Calls RCA 1802 program at address NNN. Not necessary for most ROMs. |
| - [x] | 00E0 | `disp_clear()` | Clears the screen. |
| - [x] | 00EE | `return;` | Returns from a subroutine. |
| - [x] | 1NNN | `goto NNN;` | Jumps to address NNN. |
| - [x] | 2NNN | `*(0xNNN)()` | Calls subroutine at NNN. |
